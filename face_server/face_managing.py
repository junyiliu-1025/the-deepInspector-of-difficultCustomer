...
from face_function import images_path, sub_wd, sub_hi, img_hi, img_wd
from face_function import button_img, back_ground, add_window, add_delete_window, close
...
def management_window():
    ...
    oke_identify = ttk.Button(root, style='bd.TButton', image=oi,command=run_face_recognize)

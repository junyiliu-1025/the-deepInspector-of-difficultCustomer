...
#    aa = 'C:/code/Graduate_Project/face_client/faces/test_file/2019_10_19_17-15-53-935650.bmp'
    ...
    train_model = ttk.Button(root, style='bd.TButton', image=p_train, command=lambda:TrainModel(image_path,oke_br_combo.get(),select_r_combo.get(),img_label_face,adv_text_rec,oke_text_rec))
    ...
    photo_face = Image.open('./images/'+default_face)
    photo_face = photo_face.resize((img_wd, img_hi), Image.ANTIALIAS)
    pp = ImageTk.PhotoImage(photo_face)

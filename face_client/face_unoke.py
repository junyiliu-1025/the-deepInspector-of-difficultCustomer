# -*- coding: utf-8 -*-
"""
Created on Sat Dec  7 22:31:23 2019
...
def run_face_oke(root):
    os.popen('python face_oke.py')
    root.withdraw()
arry = []
global path_c
path_c =  './faces/train/unokes'
kind = '2'
...
pok_picture = ttk.Button(root, text="奧客檔案", style='bd.TButton', image=pok,command=lambda:run_face_oke(root))
pok_picture.place(relx=0.75, rely=0.60)
'''
punok = back_ground(sub_wd, sub_hi, bg, 0.755, 0.505, text_wd, text_hi, "unoke_file.png")
punok_picture = ttk.Button(root, text="非奧客檔", style='bd.TButton', image=punok,command=lambda:change_path('./faces/train/unokes', arry, root, frm, cnv))
punok_picture.place(relx=0.75, rely=0.50)
'''
